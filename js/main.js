    ...
    for(let i = 0; i < product_cart.length; i++){
        items_c += `
            ...
            <div class="content">
                ...
                <p class="price_cart">R$${product_cart[i].price}</p>
            </div>
      ...
      price_cart_Head.innerHTML = "R$" + total_price

      count_item.innerHTML = product_cart.length
      count_item_cart.innerHTML = `(${product_cart.length} itens )`
      price_cart_total.innerHTML ="R$" +  total_price
}
...
function remove_from_cart(index){
    ...
    for (let i = 0; index < addToCartButtons.length; i++) {
